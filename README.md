...
<a id="korean"></a>
# 🍁 Meki Remote (메키 리모트)
**가장 가볍고 안전한 메이플키우기 전용 원격 제어 솔루션**
...
## 🎁 임시 무료 사용 키 (Free Trial Key)
현재 베타 테스트 기간으로, 아래 인증 키를 입력하시면 누구나 모든 기능을 무료로 사용하실 수 있습니다!
*   **인증 키(Key):** `chaos`
*   **사용 기한:** ~ 2026년 7월 7일까지
> 💡 *해당 기한까지의 유저 반응과 피드백을 종합하여, 이후에도 계속 완전 무료로 배포할지 결정할 예정입니다. 많은 사용과 피드백 부탁드립니다!*
...
### PC 클라이언트
<p align="center">
  <img src="프로그램화면1.png" width="48%">
  <img src="프로그램화면2.png" width="48%">
</p>

### 웹 제어 화면 (모바일/PC)
<p align="center">
  <img src="웹화면1.png" width="48%">
  <img src="웹화면2.jpg" width="48%">
</p>
...
Meki Remote는 개인 개발자의 열정으로 만들어진 소프트웨어입니다. 프로그램이 마음에 드셨다면 서버 유지보수와 지속적인 업데이트를 위해 따뜻한 후원 부탁드립니다! (프로그램 내 우측 하단 QR 코드를 통해서도 후원하실 수 있습니다.)
...
*   **광고 및 비즈니스 제휴 문의:** *(p0708jh@gmail.com)*
...
<a id="english"></a>
# 🍁 Meki Remote
**The Lightest & Most Secure Remote Control Solution for MapleIdle**
...
## 🎁 Free Trial Key
During our current beta testing phase, anyone can use all features for free by entering the key below!
*   **Auth Key:** `chaos`
*   **Valid Until:** July 7, 2026
> 💡 *We will decide whether to keep the software completely free permanently based on user response and feedback leading up to this date. We welcome your feedback!*
...
### PC Client
<p align="center">
  <img src="gui1.png" width="48%">
  <img src="gui2.png" width="48%">
</p>

### Web Interface (Mobile/PC)
<p align="center">
  <img src="web1.jpg" width="48%">
  <img src="web2.jpg" width="48%">
</p>
...
## 🤝 Donate & Contact
Meki Remote is a software created out of a solo developer's passion. If you find this tool helpful, please consider donating to support server maintenance and continuous updates! (You can also donate via the QR code in the bottom right corner of the app).

*   **BTC:** `bc1qcf9unc4v759cmt35fsg9xg8epjfsw3kvycr3lr`
*   **ETH:** `0x73639d754742a89bf9b2fd4ac0c9aa7661f3d42a`
*   **TRX:** `TVu5ev7NKrF6tdQonWreHBsYrT4YQKkw83`
*   **Business / Ads Inquiry:** *(p0708jh@gmail.com)*
